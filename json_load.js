...
change = "－" + Number(change).toLocaleString()
	...
	table_data += "<tr><td>" + data.city[i].name + "</td><td style=\"text-align: right\">" + Number(data.city[i].population).toLocaleString() + "</td><td style=\"text-align: right\">" + Number(data.city[i].patient).toLocaleString() + "</td><td style=\"text-align: right\">" + change + "</td><td>" + Math.round((data.city[i].patient) / (data.city[i].population)*100)/1000 + "%</td></tr>";
	}}
