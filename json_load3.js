...
function getJsonp_GAS() {
  ...
  var table_data = "";
  fetch('https://script.google.com/macros/s/AKfycbysGozVtCq3KedCaYZo2Tk_sycdysgkdn7__fQvA8InTQGju41hiv6xaCA2BASbI3vp/exec', ).then(function (response) {
    ...
    for (var i = 0; i <= (data.city.length - 1); i++) {
      ...
      if (data.city[i].name == "大阪府外" || data.city[i].name == "不明") {
        table_data += "<tr><td>" + data.city[i].name + "</td><td style=\"text-align: right\"></td><td style=\"text-align: right\">" + Number(data.city[i].patient).toLocaleString() + "</td><td style=\"text-align: right\">" + "準備中" + "</td><td></td><td style=\"display:none\"></td></tr>";
      } else {
        table_data += "<tr><td>" + data.city[i].name + "</td><td style=\"text-align: right\">" + Number(data.city[i].population).toLocaleString() + "</td><td style=\"text-align: right\">" + Number(data.city[i].patient).toLocaleString() + "</td><td style=\"text-align: right\">" + "準備中" + "</td><td>" + proportion_per + "</td><td style=\"display:none\">" + proportion_percent + "</td></tr>";
      }
    }
